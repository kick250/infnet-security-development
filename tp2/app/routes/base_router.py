...
class BaseRouter:
    ...
    def _add_api_route(self, path, handler_method, methods, response_class=JSONResponse):
        self.__router.add_api_route(path, handler_method, methods=methods, response_class=response_class)
